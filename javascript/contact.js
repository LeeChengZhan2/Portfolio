function downloadFYP() {
    var url = '/LeeChengZhan_FPY.pdf'; // Replace with the URL of the file you want to download
...
function downloadCV() {
    var url = '/LeeChengZhan_Resume_Mar2023.docx'; // Replace with the URL of the file you want to download
